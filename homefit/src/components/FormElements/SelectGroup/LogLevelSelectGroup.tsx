...
interface LogLevelSelectGroupProps {
  levelFilter: string;
...
const LogLevelSelectGroup: React.FC<LogLevelSelectGroupProps> = ({ levelFilter, setLevelFilter }) => {
  return (
    <SelectGroupWrapper>
      <select 
...
export default LogLevelSelectGroup;