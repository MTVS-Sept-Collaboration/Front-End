                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="emailAddress"
                      placeholder="이메일"
                      defaultValue="parousia0918@gmail.com"
                    />
                  </div>
                </div>
              ...
              <form>
                <div className="mb-4 flex items-center gap-3">
                  <div className="h-14 w-14 rounded-full">
                    <>
                      <Image
                        src="https://avatars.githubusercontent.com/u/17983434?v=4"
                        width={55}
                        height={55}
                        alt="User"
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="mt-2.5 text-body-sm font-medium">
                      <span className="text-primary">클릭하여 업로드</span> 혹은
                      사진을 드래그 앤 드롭
                    </p>
                    <p className="mt-1 text-body-xs">
                      SVG, PNG, JPG 혹은 GIF (최대, 200px)
                    </p>
                  </div>
                </div>
