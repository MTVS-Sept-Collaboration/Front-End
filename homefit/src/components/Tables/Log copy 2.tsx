...
//               <th className="min-w-[100px] px-4 py-4 font-medium text-dark dark:text-white">로그 레벨</th>
//               <th className="min-w-[200px] px-4 py-4 font-medium text-dark dark:text-white">로거</th>
